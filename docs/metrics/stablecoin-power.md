...
**version:** `v1.0.0`
**Alias:** `sp`  
**Endpoints:** main: `coingecko.global_market`, supplementary: `coingecko.stables_markets`
...
```bash
# Basic
cryptospec-cli stablecoin-power

# With alias
cryptospec-cli sp

# With detail
cryptospec-cli stablecoin-power --detail full

# With flag (if applicable)
cryptospec-cli stablecoin-power --{flag-name}
```
