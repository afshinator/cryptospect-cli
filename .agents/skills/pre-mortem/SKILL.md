---
name: pre-mortem
description: Write fictional post-mortem reports for bugs that haven't happened yet. Use when the user asks for a pre-mortem, wants to identify fragile code, or wants to find places where future edits could break things non-obviously.
---
